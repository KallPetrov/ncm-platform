# API Документация - LANi-Platform

Добре дошли в официалната API документация на LANi-Platform за автоматизация и управление на мрежови конфигурации. Всички заявки изискват `Content-Type: application/json`, освен ако не е посочено друго.
