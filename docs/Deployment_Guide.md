# Ръководство за Внедряване - LANi-Platform

Този документ предоставя пълни инструкции за внедряване (deployment) на LANi-Platform в производствена среда с фокус върху висока наличност, сигурност и резервно копиране.
