# Ръководство за Разработчици - NCM Платформа

Този документ е предназначен за софтуерни инженери, които искат да разширяват, тестват и допринасят за разработката на NCM Платформата.
